...
class VerifyCheckDigit(unittest.TestCase):
    ...
    def test_verify_check_digit_6th_character_only_be_1_2_or_3(self):
        ...
        self.assertEqual("The sixth character must be 1 2 or 3", error,
                         "When passed an non 12or 3 character in index 5 place returns appropriate error.")
    ...
    def test_verify_check_digit_7th_character_only_be_1_2_3_or_4(self):
        ...
        self.assertEqual("The seventh character must be 1 2 3 or 4", error,
                         "When passed an non 1,2,3 or 4 character in index 6 place returns appropriate error.")
